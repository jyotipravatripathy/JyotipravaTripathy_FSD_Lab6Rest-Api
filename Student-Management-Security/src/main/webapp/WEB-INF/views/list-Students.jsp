...
<body>
	<div class="container">
		<h2 class="display-1 text-center" style="font-weight: 700;background-image: linear-gradient(to right, gray,violet, indigo, blue, green, yellow, orange, red);   -webkit-background-clip: text;
  color: transparent">Students Directory</h2>
		...
		</td><td align="right"><a href="/StudentManagement/logout" 
